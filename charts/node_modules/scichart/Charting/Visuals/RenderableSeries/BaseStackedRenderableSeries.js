...
var BaseStackedRenderableSeries = /** @class */ (function (_super) {
     ...
     */
    BaseStackedRenderableSeries.prototype.getXRange = function () {
     ...
     */
    BaseStackedRenderableSeries.prototype.getYRange = function (xVisibleRange, isXCategoryAxis) {
     ...
     */
    BaseStackedRenderableSeries.prototype.hasDataSeries = function () {
     ...
     */
    BaseStackedRenderableSeries.prototype.hasDataSeriesValues = function () {
    ...
    Object.defineProperty(BaseStackedRenderableSeries.prototype, "isRunningAnimation", {
        get: function () {
            throw Error("isAnimationRunning is not supported for BaseStackedRenderableSeries");
        },
        enumerable: false,
        configurable: true
    });
    BaseStackedRenderableSeries.prototype.enqueueAnimation = function (animation) {
        throw Error("animationEnqueue is not supported for BaseStackedRenderableSeries");
    };
